...
using MrMood.DataAccess.Extensions;
using MrMood.Domain;
using System;
using System.Linq;
...
namespace MrMood.DataAccess.Initializer
{
    public class DbInitializer
    {
        public static void Initialize(MoodContext context)
        {
            ...
            iasamani.Tags.Add(work);
            zurchanta.Tags.Add(work);
            neKino.Tags.Add(work);
            chaika.Tags.Add(work);
            iavnana.Tags.Add(work);
            human.Tags.Add(work);
            bolelshik.Tags.Add(work);
            seredniViky.Tags.Add(work);
            samnamgulebs.Tags.Add(smooth);
            gala.Tags.Add(smooth);
            vazi.Tags.Add(smooth);
            onlyYou.Tags.Add(smooth);
            budSmelim.Tags.Add(smooth);
            bet.Tags.Add(smooth);
            bet.Tags.Add(funny);
            goreDolom.Tags.Add(funny);
            take.Tags.Add(funny);
            take.Tags.Add(effective);
            blueSea.Tags.Add(effective);
            relado.Tags.Add(effective);
